...
def summary():
    ...
    return jsonify({
        ...
        "average_altitude": round(avg_alt, 2) if avg_alt else 0,
        "average_velocity": round(avg_vel, 2) if avg_vel else 0
    })
...
AVIATIONSTACK_KEY = "5e4ff96642cac8c24017fc5b49d11850"
